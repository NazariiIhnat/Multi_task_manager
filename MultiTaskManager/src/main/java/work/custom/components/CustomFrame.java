...
public abstract class CustomFrame extends JFrame implements Closeable {
    ...
    public CustomFrame(String frameName, int x, int y, int width, int height){
        ...
        contentPane.setBorder(new LineBorder(Settings.HIGHLIGHT_COLOR));
        ...
        upperPanel.setBackground(Settings.SOFT_BLUE);
    ...
    private JLabel minimizeLabel() {
        ...
        label.setBackground(Settings.SOFT_BLUE);
    ...
    class LabelsPainter extends MouseAdapter {
        ...
        public void mouseReleased(MouseEvent e) {
            e.getComponent().setBackground(Settings.SOFT_BLUE);
        }
